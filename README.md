...
# 🚀 AHK in GPT GEMINI (for Microsoft Edge)
![ahk gpt gemini](https://github.com/user-attachments/assets/98dea895-12dd-405f-b5a9-cd0c87d1ec1a)


**Dual Search Helper**는 한 번의 입력으로 **Gemini**와 **ChatGPT**에서 동시에 해답을 찾을 수 있도록 돕는 AutoHotkey 기반의 생산성 도구입니다.  
